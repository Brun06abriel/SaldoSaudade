...
public class FuncionarioDAO {
    ...
    public int DefinirHorario(int id){
        CBD.conectar();
        int HrsDef=0;
        String sql = "select (cargaHoraria) from Horario where id = ?;" ;
         try {
    /* Executando o comando select */
     ...
     while (rs.next()) {
      int carga_bd = rs.getInt("CargaHoraria");
      
      switch(id){
          case 1: HrsDef = carga_bd * 20 ; break;
          case 2: HrsDef = carga_bd * 20; break;
          case 3: HrsDef = carga_bd * 20; break;
          case 4: HrsDef = carga_bd * 4 ; break;
          case 5: HrsDef = carga_bd * 4 ; break;
      }
    ...
    return HrsDef;
     ...
     public int DefinirSalario(int id){
        CBD.conectar();
        int SlrDef=0;
