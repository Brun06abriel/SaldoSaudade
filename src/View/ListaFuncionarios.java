...
public class ListaFuncionarios extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        Benef.setText("Definir beneficios");
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
     int Selecionado = jTableFuncionarios.getSelectedRow();
        if(Selecionado >= 0 ){
         int  IDSelecionado = Integer.parseInt(jTableFuncionarios.getValueAt(Selecionado, 0).toString());
         CalcularSalarioBruto TelaSalBruto = new CalcularSalarioBruto(IDSelecionado);
         ListaFuncionarios.this.dispose();
         TelaSalBruto.setLocation(500, 300);
         TelaSalBruto.setVisible(true);
        }else{
